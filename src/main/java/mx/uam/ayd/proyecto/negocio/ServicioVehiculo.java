...
public class ServicioVehiculo {
    ...
    public Vehiculo agregaVehiculo(String marca, String modelo, String placas, int anio, double kilometraje, Cliente cliente) {
        ...
        Vehiculo vehiculoExistente = vehiculoRepository.findByPlacas(placas);
        if (vehiculoExistente != null) {
            throw new IllegalArgumentException("Ya existe un vehículo registrado con las placas: " + placas);
        }
        
        log.info("Agregando vehículo "+marca+" "+modelo+" con placas:"+placas);

        // crea y guarda el vehículo en la base de datos
